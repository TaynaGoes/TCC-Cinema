                    ...
                    <div class="row">
                        <div class="panel-container_center__wrapper">
                            <div class="panel-center_top">
                                <h3 class="panel-center_title">Nova Categoria Produto</h3>
                            </div>

                            <div class="panel-center_form">
                                <form action="./app/cadastro_categoria_produto.php" method="post" class="film_form">
                                    <!-- Nome -->
                                    <label for="filme_nome" class="film_label">Nome</label>
                                    <input type="text" name="nome" id="nome" class="film_input">
