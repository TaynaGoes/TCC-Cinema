                    ...
                    <div class="row">
                        <div class="panel-container_center__wrapper">
                            <div class="panel-center_top">
                                <h3 class="panel-center_title">Alterar Filme</h3>
                            </div>
                            <?php 
                            ...
                            <div class="panel-center_form">
                                <form action="./app/alterar_filme.php" method="post" enctype="multipart/form-data" class="film_form">
                                    ...
                                    <input type="time" name="duracao" id="filme_duracao" class="film_input film_timer" value="<?=$linha['duracao'];?>">
