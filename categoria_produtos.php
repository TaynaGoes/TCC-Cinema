                    ...
                    <div class="row">
                        <div class="panel-container_center__wrapper">
                            <div class="panel-center_top">
                                <h3 class="panel-center_title">Categoria de Produtos</h3>
                                <div class="panel-button_wrapper">

                                    <button class="panel-button panel-button_register">
                                        <a href="categoria_produtos_add.php" class="button">
                            ...
                            <div class="col-12">
                                <table class="table table_view">
                                    ...
                                    <?php
                                        ...
                                        foreach($categorias_produto as $linha) {
                                    ?>
                                    ...
                                    <tbody>
                                        <tr class="table_row">
                                            ...
                                            <td class="table_button__container">
                                                <a href="categoria_produtos_alterar.php?id=<?=$linha['id'];?>" class="table_button table_button__update">
                                                    <i class="table_button__icon">
                                                        <img src="src/imagens/icon/update.png" alt="" srcset="">
                                                    </i>
                                                    Editar
                                                </a>
                                                <a href="categoria_produtos_remover.php?id=<?=$linha['id'];?>" class="table_button table_button__delete">
                                                    <i class="table_button__icon">
