<?php
    ...
    try {
        $comandoSQL = $conexao->prepare("UPDATE filme SET nome = :nome, sinopse = :sinopse, categoria = :categoria,
        duracao = :duracao, legendado = :legendado, dublado = :dublado, resolucao = :resolucao, ativo = :ativo, imagem = :imagem WHERE id = :id");
