                    ...
                    <div class="row">
                        <div class="panel-container_center__wrapper">
                            <div class="panel-center_top">
                                <h3 class="panel-center_title">Novo Produto</h3>
                            </div>
                            <div class="panel-center_form">
                                <form action="./app/cadastro_produto.php" method="post" enctype="multipart/form-data" class="film_form">
                                    <!-- Nome -->
                                    ...
                                    <input type="number" min="0.00" max="10000.00" step="0.01" name="valor"
                                        id="filme_duracao" class="film_input film_timer">
                                    ...
                                    <div class="panel-button_wrapper">
                                        ...
                                        <button class="panel-button panel-button_view">
                                            <a href="painel_adm__view-product.php" class="panel-button_view__text">Visualizar</a>
                                        </button>
                                    </div>
