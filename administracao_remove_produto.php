                    ...
                    <div class="row">
                        <div class="panel-container_center__wrapper">
                            <div class="panel-center_top">
                                <h3 class="panel-center_title">Excluir Produto</h3>
                            </div>
                            ...
                            <div class="panel-center_form">
                                <form action="./app/excluir_produto.php" method="post" enctype="multipart/form-data" class="film_form">
                                    ...
                                    <select disabled name="categoria" class="film_input film_select">
                                            ...
                                            ?>
                                                <option value="0"><?=$categorias_produto[$i]['nome'];?></option>
                                            <?php
                                                    }
                                                }
                                            ?>  
                                    ...
                                    <textarea disabled name="descricao" id="filme_descricao" cols="30" rows="3"
                                        class="film_input film_textarea"><?=$linha['descricao'];?></textarea>

                                    <!-- Valor -->
                                    <label for="filme_duracao" class="film_label">Valor</label>
                                    <input disabled type="number" min="0.00" max="10000.00" step="0.01" name="valor"
