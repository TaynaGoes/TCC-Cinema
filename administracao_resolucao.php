                    ...
                    <div class="row">
                        <div class="panel-container_center__wrapper">
                            <div class="panel-center_top">
                                <h3 class="panel-center_title">Resoluções</h3>
                                <div class="panel-button_wrapper">

                                    <button class="panel-button panel-button_register">
                                        <a href="administracao_resolucao_add.php" class="button">
                                    ...
                                    <tbody>
                                        <tr class="table_row">
                                            ...
                                            <td class="table_button__container">
                                                <a href="administracao_resolucao_alterar.php?id=<?=$linha['id'];?>" class="table_button table_button__update">
                                                    <i class="table_button__icon">
                                                        <img src="src/imagens/icon/update.png" alt="" srcset="">
                                                    </i>
                                                    Editar
                                                </a>
                                                <a href="administracao_resolucao_remover.php?id=<?=$linha['id'];?>" class="table_button table_button__delete">
                                                    <i class="table_button__icon">
