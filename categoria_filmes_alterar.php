                    ...
                    <div class="row">
                        <div class="panel-container_center__wrapper">
                            <div class="panel-center_top">
                                <h3 class="panel-center_title">Alterar Gênero Filme</h3>
                            </div>

                            <?php require_once('./app/obter_categoria_filme.php'); ?>

                            <div class="panel-center_form">
                                <form action="./app/alterar_categoria_filme.php" method="post" class="film_form">
                                    ...
                                    <div class="panel-button_wrapper">
                                        ...
                                        <button type="submit" class="panel-button panel-button_confirm">Salvar</a>
                                    </div>
                                </form>
                            </div>     
