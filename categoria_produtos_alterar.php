                    ...
                    <div class="row">
                        <div class="panel-container_center__wrapper">
                            <div class="panel-center_top">
                                <h3 class="panel-center_title">Alterar Categoria Produto</h3>
                            </div>

                            <?php require_once('./app/obter_categoria_produto.php'); ?>

                            <div class="panel-center_form">
                                <form action="./app/alterar_categoria_produto.php" method="post" class="film_form">
                                    <input type="hidden" name="id" value="<?=$linha['id'];?>">

                                    <!-- Nome -->
                                    <label for="filme_nome" class="film_label">Nome</label>
                                    <input type="text" name="nome" id="nome" class="film_input" value="<?=$linha['nome'];?>">

                                    <div class="panel-button_wrapper">
                                        <a href="categoria_produtos.php" class="panel-button panel-button_cancel">Cancelar</a>
